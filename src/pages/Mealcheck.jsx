      ...
      <div className="max-w-xl mx-auto px-4 space-y-5">
        ...
        <div className="group rounded-[2rem] p-5 text-white bg-ink shadow-lg">
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              { lbl: 'المركز',  val: profile?.center,                   cls: 'text-primary' },
        ...
        {items.length === 0 && (
          <div className="bg-white border border-line rounded-2xl py-14 text-center shadow-sm">
            ...
            <p className="text-muted text-sm">لم تُسند إليك أي مهام تقييم لمركزك بعد</p>
          </div>
        )}
              ...
              return (
                <div key={`${task.id}_${mealType}_done`}
                  ...
                  <div className="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-green-100 to-emerald-100 border-2 border-green-200">
                    <meta.icon size={26} weight="regular" style={{ color: meta.color }} />
                  </div>
                  <div className="flex-1 min-w-0">
      ...
      <div dir="rtl" className="min-h-screen bg-canvas pb-32 font-arabic">
        <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-line w-full px-4 py-3 mb-6 shadow-sm">
          <div className="max-w-xl mx-auto flex items-center justify-between">
            ...
            <h1 className="text-base font-bold text-ink absolute left-1/2 -translate-x-1/2 whitespace-nowrap">
              مراحل تقييم الوجبة
            </h1>
            <div className="w-10" />
          </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button
                        ...
                        className={`group/btn relative min-h-[52px] py-3.5 rounded-2xl font-bold transition-all duration-300 flex items-center justify-center gap-2.5 active:scale-[0.98] overflow-hidden ${
                          isYes
                            ? (yesGood
                                ? 'text-white shadow-[0_6px_20px_rgb(var(--c-success)/0.4)] scale-[1.02]'
                                : 'text-white shadow-[0_6px_20px_rgb(var(--c-error)/0.4)] scale-[1.02]')
