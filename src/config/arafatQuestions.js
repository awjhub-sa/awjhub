...
export const ARAFAT_SECTIONS = [
  {
    ...
    criteria: [
      ...
      { id: 3,  text: 'هل تم وضع المستندات الرسمية للمنشأة في لوحة ظاهرة داخل المطبخ؟', score: 0.25, type: 'yesno' },
      /* سؤال «الطاقة الكهربائية والأحمال» محذوف */
      { id: 4,  text: 'هل يوجد مصادر مياه متوفرة داخل المطبخ مع توفر المياه داخل الخزان الإحتياطي؟', score: null, type: 'yesno' },
      { id: 5,  text: 'هل تم وضع قائمة الوجبات الغذائية (المنيو) بلغة الحاج في لوحة المعلومات طيلة فترة الموسم؟', score: 1,    type: 'yesno' },
      { id: 6,  text: 'هل تم وضع مواعيد توزيع الوجبات الغذائية بلغة الحاج في لوحة المعلومات طيلة فترة الموسم؟', score: 1,    type: 'yesno' },
      { id: 7,  text: 'هل يوجد ملصقات توعوية عن سلامة الغذاء داخل المطبخ؟', score: 1,    type: 'yesno' },
      { id: 8,  text: 'هل صواعق الحشرات الكهربائية نظيفة وتعمل؟', score: 0.25, type: 'yesno' },
  ...
  },
  {
    ...
    title: 'متطلبات فنية',
    criteria: [
      { id: 10, text: 'هل تم توفير حافظات (غرف الثلج)؟', score: 0.25, type: 'yesno' },
      { id: 11, text: 'هل تم توفير كميات كافية من الثلج داخل حافظة الثلج؟', score: 0.50, type: 'yesno' },
      { id: 12, text: 'هل مواقد الطبخ متناسبة لعمليات الطبخ من حيث الإنشاء وتم تجربتها؟', score: 1,    type: 'yesno' },
      { id: 13, text: 'هل تم توفير فلتر للمياه (فلتر ثلاثي) داخل المطبخ؟', score: 0.75, type: 'yesno' },
      {
        id: 14,
      ...
      { id: 18, text: 'هل تم توفير مياه للشرب بشكل كافٍ داخل الموقع (علب – ريطات / شرنكات)؟', score: 2,    type: 'yesno' },
      { id: 19, text: 'هل تم توفير المواد الأساسية الغذائية من المتعهد (المواد الخام + البروتين)؟', score: 2,    type: 'yesno' },
      ...
      { id: 23, text: 'هل الحطب متوفر بكميات كافية؟', score: 1,    type: 'yesno' },
