...
export const MINA_SECTIONS = [
  {
    ...
    criteria: [
      ...
      { id: 4,  text: 'هل يوجد مصادر مياه متوفرة داخل المطبخ وللمرافق التابعة للمركز (دورات المياه)؟', score: null, type: 'yesno' },
      { id: 5,  text: 'هل تم وضع قائمة الوجبات الغذائية (المنيو) بلغة الحاج في لوحة المعلومات طيلة فترة الموسم؟', score: 1,    type: 'yesno', requiresPhoto: true },
      ...
      { id: 8,  text: 'هل تم توفير مغسلة أيدي داخل المطبخ (بخاصية عمل مستشعر / حساس)؟', score: 0.75, type: 'yesno' },
      { id: 9,  text: 'هل صواعق الحشرات الكهربائية نظيفة وتعمل؟', score: 0.25, type: 'yesno' },
      { id: 10, text: 'هل تم توفير دولاب مخصص للأغراض الشخصية للعاملين؟', score: null, type: 'yesno' },
      { id: 11, text: 'هل تم تنظيف غرفة الزيت / التفتيش بحيث تكون خالية من الرواسب؟', score: 1,    type: 'yesno' },
    ],
  },
  {
    id: 'technical',
