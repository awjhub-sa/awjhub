...
export const MINA_SECTIONS = [
  ...
  },
  {
    ...
    title: 'متطلبات فنية',
    criteria: [
      { id: 12, text: 'هل تم توفير مياه للشرب بشكل كافٍ داخل الموقع (علب – ريطات / شرنكات)؟', score: 2,    type: 'yesno' },
      ...
      { id: 19, text: 'هل يتم تخزين المواد الغذائية بطريقة آمنة وسليمة؟', score: 0.25, type: 'yesno' },
      ...
      { id: 24, text: 'هل تم توفير كميات كافية من الثلج داخل حافظة الثلج؟', score: 0.50, type: 'yesno' },
      { id: 25, text: 'هل تم توفير الوجبات الجافة بكميات كافية (وجبات احتياطية)؟', score: 1,    type: 'yesno' },
    ],
  },
];
